...
class TestEmployeeID(common.TransactionCase):
    ...
    def test_random_id_generation(self):
        ...
        self.assertAlmostEqual(len(employee.s_identification_id), 5)
    ...
    def test_random_id_generation_changed_digits(self):
        ...
        self.assertAlmostEqual(len(employee.s_identification_id), 10)
    ...
    def test_sequences_id_generation(self):
        ...
        self.assertTrue(len(employee.s_identification_id))
    ...
    def test_no_sequences_id_generation(self):
        ...
        self.assertEqual(employee.s_identification_id, False)
    ...
    def test_custom_id(self):
        ...
        employee = self.employee_model.create({
            'name': 'Employee', 's_identification_id': 'THERE_YOU_GO'
        })
        self.assertEqual(employee.s_identification_id, 'THERE_YOU_GO')
