...
class SaleReport(models.Model):
    ...
    total_amount_qty_delivery = fields.Float(string='*Deliveried Amount', readonly=True,
                                                help="Total amount Qty Delivery")
    @api.model
    def _query(self, with_clause='', fields={}, groupby='', from_clause=''):
        ...
        select_ = """
            ...
            sum(l.sea_price_total_qty_delivered / CASE COALESCE(s.currency_rate, 0) WHEN 0 THEN 1.0 ELSE s.currency_rate END) as total_amount_qty_delivery,
