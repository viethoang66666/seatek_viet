...
class TestStockCard(common.TransactionCase):
    ...
    def _getQwebReportName(self):
        return 'sea_stock_card_report.report_stock_card_report_pdf'

    def _getXlsxReportName(self):
        return 'sea_stock_card_report.report_stock_card_report_xlsx'

    def _getXlsxReportActionName(self):
        return 'sea_stock_card_report.action_report_stock_card_report_xlsx'
